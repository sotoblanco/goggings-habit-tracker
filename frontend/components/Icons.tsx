...
export const RepeatIcon: React.FC<{ className?: string; title?: string }> = ({ className = "w-4 h-4", title }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        {title && <title>{title}</title>}
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0m0 0c1.863-1.863 1.863-4.887 0-6.75s-4.887-1.863-6.75 0-1.863 4.887 0 6.75Zm-11.667 0c1.863 1.863 4.887 1.863 6.75 0s1.863-4.887 0-6.75-4.887 1.863-6.75 0Z" />
    </svg>
);
...
// FIX: Add `title` prop to allow for tooltips, matching `ArrowDownIcon`.
export const ArrowUpIcon: React.FC<{ className?: string; title?: string }> = ({ className = "w-6 h-6", title }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        {title && <title>{title}</title>}
...
export const ArrowDownIcon: React.FC<{ className?: string; title?: string }> = ({ className = "w-6 h-6", title }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        {title && <title>{title}</title>}
...
export const PencilSquareIcon: React.FC<{ className?: string; title?: string }> = ({ className = "w-6 h-6", title }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        {title && <title>{title}</title>}
        <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
    </svg>
...
export const FlagIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v1.5M3 21v-6.375c0-.621.504-1.125 1.125-1.125H9.75v0c.621 0 1.125.504 1.125 1.125V21" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 3h12.75A2.25 2.25 0 0 1 18 5.25v9.75a2.25 2.25 0 0 1-2.25 2.25H3.125" />
    </svg>
);

export const RibbonIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M5.165 2.472a.75.75 0 0 1 1.06 0l2.473 2.471a.75.75 0 0 1 0 1.06L6.225 8.472a.75.75 0 0 1-1.06 0L2.742 6.048a.75.75 0 0 1 0-1.06l2.423-2.516Zm10.5 0a.75.75 0 0 1 1.06 0l2.473 2.471a.75.75 0 0 1 0 1.06l-2.473 2.471a.75.75 0 0 1-1.06 0L13.192 6.048a.75.75 0 0 1 0-1.06l2.473-2.516Z" clipRule="evenodd" />
        <path d="M12 1.5a.75.75 0 0 1 .75.75V3h3.375a3 3 0 0 1 3 3v13.5a1.5 1.5 0 0 1-2.25 1.35l-4.5-2.25a.75.75 0 0 0-.692 0l-4.5 2.25A1.5 1.5 0 0 1 4.875 21V6a3 3 0 0 1 3-3H11.25V2.25A.75.75 0 0 1 12 1.5Z" />
    </svg>
);

export const StarIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.116 3.546 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.546c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.006Z" clipRule="evenodd" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.28c-.48.036-.954.224-1.32.53l-2.5 2.5c-.52.52-1.38.52-1.9 0l-2.5-2.5a2.625 2.625 0 0 1-1.32-.53l-3.722-.28c-1.133-.093-1.98-1.057-1.98-2.193V10.608c0-.97.616-1.813 1.5-2.097m14.25-2.131c.224-.07.448-.134.672-.192m-14.944 0c.224.058.448.122.672.192m13.6 8.162c.224.07.448.134.672.192m-14.944 0c.224-.058.448-.122.672-.192M9 10.5a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm3.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm3.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
    </svg>
);

export const LightBulbIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c-1.42 0-2.798-.83-3.465-2.126a7.5 7.5 0 0 1 14.43 0c-.667 1.296-2.045 2.126-3.465 2.126Z" />
    </svg>
);
...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 0 1 4.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19 14.5M14.25 3.104c.251.023.501.05.75.082M19 14.5v-5.714c0-.597-.237-1.17-.659-1.591L14.25 3.104M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 4.5h.008v.008H12v-.008Z" />
    </svg>
);
